...
| **Strategy_21** | [Strategy21](file:///g:/100%20Days%20of%20code/boxdata/Live%20trading/nifty_options_aws_deployment/strategies/strategy_21.py) | Aroon HA Oscillator | 1-Minute | Aroon Oscillator computed on Heikin-Ashi High/Low with a 1.0x ATR stop-loss and session end square-off. |
| **Strategy_22** | [Strategy22](file:///g:/100%20Days%20of%20code/boxdata/Live%20trading/nifty_options_aws_deployment/strategies/strategy_22.py) | Modular EMA/SMMA OHLC4 Engine | 1-Minute | Modular framework evaluating OHLC4 EMA18 vs SMMA18 with selectable entry modes (Crossover, Persistence, Spread Expansion, Pullbacks) and dynamic exits. |
