...
def main():
    ...
    print("-" * 70)
    print("  The following status applies to this codebase:")
    print("    [OK]       daily_trade_counts IS isolated per strategy and per account.")
    print("               Strategy_A trading N times will not block Strategy_B.")
