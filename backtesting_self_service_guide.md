...
*   `--strategy` / `-s`: Strategy index to run (1-7).
...
*   **Limit**: Dhan's API allows intraday charts query ranges up to 365+ days. For runs extending further back, you can append/provide your own historical spot CSV file directly in the `backtest_data/` directory.
